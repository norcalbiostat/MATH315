...
When errors occur, because they always will, start to read the error messages with an intent to understand what they are saying. Here are some common examples
