...
## Collaborative Notes on R 
A collection of student generated notes on how to do things in R. 
https://hackmd.io/Ue0ojg6xRWC4fP3Xg3Tveg
...
* Most homework assignments will come with a R markdown (`*.Rmd`)  template file to use.
    - If you left click on the link and it opens in a HTML browser window, it will not work this way.
    - Right click on the link to download this file and `save as` or `save target as`. 
...
* I will download these files, write comments and corrections on the PDF electronically, and assign grade points rubric built into BBL. My marked up assignment file will be returned to you via BBL. 

**Project Assignments**

* Project assignments are completed directly in Google Docs. 
* Drop a note in the corresponding assignment in Blackboard Learn saying your assignment is ready for review. 
