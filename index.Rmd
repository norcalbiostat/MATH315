...
**You have 2 assignments to turn in this week!** Read the instructions of each carefully to ensure that they are completed and submitted correctly. 

1. A literature review (pair). ([Homework 03](hw/hw03_lit_review.html))  
2. Demonstration of data management code (individual). ([Homework 04](hw/hw04_data_management.html)). 
...
In class you will work with your partner to take a closer look at your codebook to identify what types of data management you will have to do. The `lec03_dm_prep_questions` lecture notes that can be found on the materials page contain questions to help guide this process. 

Here are some videos to see how to get your data into R Studio. 

* R Studio Cloud [LINK TBD]
* R Studio on your desktop [LINK TBD]
