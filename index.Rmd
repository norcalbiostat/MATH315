...
> OH Monday cancelled. I will be available 11-11:30am, 12-2pm and possibly 4-5pm instead. 


#### You have 2 assignments to turn in this week!
...
In class you will work with your partner to take a closer look at your codebook to identify what types of data management you will have to do. The `lec03_dm_prep_questions` lecture notes that can be found on the [[course materials page]](notes.html) contain questions to help guide this process. 

#### Extra Materials

* I have created a video to see [[how to get your data into R Studio]](https://670832.kaf.kaltura.com/media/How+to+import+data+into+R/0_w6buqbaw) 
    - All new videos will also be posted on the [[course materials page]](notes.html) page, below the list of PDS videos. 
