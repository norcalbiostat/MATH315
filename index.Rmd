...
* Midterms should be back by Wed or Friday
* HW 8 BIG assignment! Has multiple parts. 
* one-on-one online help with R coming soon. Wesleyan (Passion Driven Stats Developers) is offering drop in one on one help via Zoom. Link and times forthcoming. 
