...
In this assignment you and your analysis partner will:

1.  Decide on a specific research topic
2.  Choose variables that relate to your topic
3.  Propose a few research questions (RQ)
4.  Conduct a literature review to learn more about your topic
5.  Refine your proposed Research Questions based on new knowledge

## Setup

1.  Watch the following videos:
    -   Choosing a data set [PDS 2](https://youtu.be/FduVJ4tDsVo). Start at 19min.
    -   Conducting a literature review [PDS 3](https://youtu.be/ZmkUvbX-qlI)
    -   (Optional) [Video on developing a research topic that interests you](https://media.csuchico.edu/media/Developing+a+Research+Question+that+Interests+You/0_rxvxwbas)
2. Read [How to read a journal article](https://math315.netlify.app/reading/How%20to%20Read%20a%20Journal%20Article.pdf).
...
3.  Make a **copy** of the [template document](https://docs.google.com/document/d/1b-dmoH9xUNx6SJpD7OibPSP2D9rN_ewU1QGaZYChlm0/edit?usp=sharing) in our `Project Stage 1 (hw 02)` folder in our Google Drive.
    -   Rename this file `rq_pairname` with both your first names. e.g. `rq_robin_yazmin`
    -   See below for details on how to complete each step.
...
1. Put the reference for the article in APA style. 
    * Here is a link to [Purdue Owl APA style references](https://owl.english.purdue.edu/owl/resource/560/05/) that will guide you.
    * NOTE: If you use a citation creator you still need to compare each part of all your references to make sure it was done correctly. The citation creator usually messes up on something. Here are good/suggested bibliography managers
        -   [BibDesk (Mac)](http://bibdesk.sourceforge.net/), [Zotero (in browser)](https://www.zotero.org/), [Mendeley (download)](https://www.mendeley.com/)
2. Read an article, type up a brief summary (a few sentences) of what you learned about your topic from introduction/lit review and the discussion. This summary should convey the main themes and findings overall for the literature review and discussion in your own words.
