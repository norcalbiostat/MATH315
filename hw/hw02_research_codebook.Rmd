...
* This is a team assignment (one submission per analysis pair)
* Use header formats to clearly denote steps 1-3.
* Write your assignment directly in Google Docs in the `Incoming/02 Research Question` folder. 
* Name this file `rq_pairname` i.e. `rq_donatello_coia.pdf` 
* Download a copy as PDF and upload to the corresponding assignment in Blackboard Learn
* This assignment will be peer reviewed. 
    - Be sure to use the "project pairs" sheet of the [Peer Review Assignment](https://docs.google.com/spreadsheets/d/15BXa0Xx-utXAFUE5wlZDD-Z6ywV2ffLMiY4TThSnDJM/edit?usp=sharing) to find your assignments 
