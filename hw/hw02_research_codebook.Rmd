...
The specific details for each step are described below. You will conduct the work in a word document, then save as PDF and submit through Blackboard Learn.  
...
* Name this file `rq_` 
* Upload to Blackboard Learn by the due date AND place a copy in our shared Google Folder
