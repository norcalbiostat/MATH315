...
0. Use the template provided: [[RMD]](bivariate_graphing_template.Rmd). Rename this file name to: _biv_graph_userid.pdf_
...
5. Submit your knitted PDF to the **05 Bivariate Graphics** folder in Google Drive, **AND** to the corresponding Blackboard learn assignment. 
