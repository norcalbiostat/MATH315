...
**<span style="color:red">Do not worry about your data being "messy" at this point. Some of your graphics may look odd or "not right". You may have bars for NA values, or a huge spike of data at some odd value of 999. Address these oddities in your writeup. Fix them if you know how to. Data cleaning is the topic of week 3.</span>**

# Instructions

* Use the template provided: [[RMD]](hw05_graphing_template.Rmd). 
...
* Upload the final PDF to `05 Univariate Graphing` folder in Google Drive with the file name: `univ_graphing_userid.pdf`
...
Quick and dirty plot being shown, summary table. No english description provided, no verbal explanation of what information was gained from these plots. 
```{r}
hist(mpg$cty)
summary(mpg$cty)
```
