...
1. Upload the final PDF to `05 Univariate Graphing` folder in Google Drive with the file name: `univ_graphing_userid.pdf` by Sunday EOD
2. Review your peer's work by Tuesday EOD by commenting in the PDF directly in Google Drive
3. Revise (optional) your work and submit the final PDF to BBL by Thursday EOD
