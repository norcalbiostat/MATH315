...
3.  Make a **copy** of the template document in our [Project Stage 1 (hw 02)](https://drive.google.com/drive/folders/17JG_I1VoQ6bkMELBvw9CDZ3OPfFukIAC) folder in our Google Drive.
    -   Rename this file `rq_pairname` with both your first names. e.g. `rq_robin_yazmin`
4. Scroll down for details on how to complete each step in this assignment. 
