...
* Project assignments are either completed directly in Google Docs, or the compiled PDF is uploaded to Google Docs. Each assignment has it's own folder. 
* Project assignments are peer reviewed. 
* You have the option to revise your work based on the reviews you have recieved. 
* Use Blackboard learn to submit the final version either as PDF or as a note saying to look at Google Drive. This will depend on the assignment.
